<template>
  ...
  <swiper
    ...
    class="sm:hidden p-9"
  >
    <swiper-slide v-for="launche in this.verifiedByParter" :key="launche.id">
      <div class="relative w-full bg-gray-900 px-6 pt-6 pb-8 shadow-smooth border-gray-600 border rounded-2xl flex flex-col items-center">
